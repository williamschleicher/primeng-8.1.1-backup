...
let KeyFilter = KeyFilter_1 = class KeyFilter {
    constructor(el) {
        this.el = el;
    ...
    onKeyPress(e) {
        ...
        let browser = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getBrowser();
...
let KeyFilterDemoRoutingModule = class KeyFilterDemoRoutingModule {
};
...
let KeyFilterDemoModule = class KeyFilterDemoModule {
};
...
let KeyFilterDemo = class KeyFilterDemo {
    constructor() {
        this.blockSpecial = /^[^<>*#!]+$/;
        this.blockSpace = /[^\s]/;
...
//# sourceMappingURL=components-keyfilter-keyfilterdemo-module-es2015.js.map