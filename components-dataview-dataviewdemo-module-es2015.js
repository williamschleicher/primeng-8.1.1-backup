    ...
    sort() {
        ...
        if (this.lazy) {
            ...
            this.value.sort((data1, data2) => {
                let value1 = _utils_objectutils__WEBPACK_IMPORTED_MODULE_3__["ObjectUtils"].resolveFieldData(data1, this.sortField);
                let value2 = _utils_objectutils__WEBPACK_IMPORTED_MODULE_3__["ObjectUtils"].resolveFieldData(data2, this.sortField);
                let result = null;
...
let DataViewDemoRoutingModule = class DataViewDemoRoutingModule {
};
...
let DataViewDemoModule = class DataViewDemoModule {
};
...
let DataViewDemo = class DataViewDemo {
...
//# sourceMappingURL=components-dataview-dataviewdemo-module-es2015.js.map