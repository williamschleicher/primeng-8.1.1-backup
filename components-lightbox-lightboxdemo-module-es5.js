...
var Lightbox = /** @class */ (function () {
    ...
    Lightbox.prototype.center = function () {
        var elementWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.panel);
        var elementHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.panel);
    ...
    Lightbox.prototype.onImageLoad = function (event, content) {
        ...
        var imageWidth = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(image);
        var imageHeight = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(image);
    ...
    Lightbox.prototype.bindGlobalListeners = function () {
        ...
        if (this.closeOnEscape && !this.documentEscapeListener) {
            this.documentEscapeListener = this.renderer.listen('document', 'keydown', function (event) {
                if (event.which == 27) {
                    if (parseInt(_this.panel.style.zIndex) === (_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].zindex + _this.baseZIndex)) {
                        _this.hide(event);
                    }
                }
            });
