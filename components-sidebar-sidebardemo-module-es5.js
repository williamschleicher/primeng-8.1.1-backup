...
var Sidebar = /** @class */ (function () {
    ...
    Sidebar.prototype.bindDocumentEscapeListener = function () {
        ...
        this.documentEscapeListener = this.renderer.listen('document', 'keydown', function (event) {
            if (event.which == 27) {
                if (parseInt(_this.containerViewChild.nativeElement.style.zIndex) === (_dom_domhandler__WEBPACK_IMPORTED_MODULE_4__["DomHandler"].zindex + _this.baseZIndex)) {
                    _this.close(event);
                }
            }
        });
...
//# sourceMappingURL=components-sidebar-sidebardemo-module-es5.js.map