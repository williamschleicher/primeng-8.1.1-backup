...
let ContextMenuDemoRoutingModule = class ContextMenuDemoRoutingModule {
};
...
let ContextMenuDemoModule = class ContextMenuDemoModule {
};
...
let ContextMenuDemo = class ContextMenuDemo {
    ngOnInit() {
        this.items1 = [
            {
                label: 'File',
...
//# sourceMappingURL=components-contextmenu-contextmenudemo-module-es2015.js.map