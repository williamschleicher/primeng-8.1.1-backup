    ...
    bindDocumentClickListener() {
        if (!this.documentClickListener && this.dismissable) {
            this.zone.runOutsideAngular(() => {
                let documentEvent = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].isIOS() ? 'touchstart' : 'click';
...
let OverlayPanelDemoRoutingModule = class OverlayPanelDemoRoutingModule {
};
...
let OverlayPanelDemo = class OverlayPanelDemo {
    ...
    selectCar(event, car, overlaypanel) {
        this.selectedCar = car;
        overlaypanel.toggle(event);
    }
};
OverlayPanelDemo.ctorParameters = () => [
...
//# sourceMappingURL=components-overlaypanel-overlaypaneldemo-module-es2015.js.map