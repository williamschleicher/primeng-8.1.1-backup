...
let CarsListDemo = class CarsListDemo {
    constructor(carService, ref, config) {
...
let DynamicDialogDemoRoutingModule = class DynamicDialogDemoRoutingModule {
};
...
let DynamicDialogDemoModule = class DynamicDialogDemoModule {
};
...
let DynamicDialogDemo = class DynamicDialogDemo {
    constructor(dialogService, messageService) {
        this.dialogService = dialogService;
        this.messageService = messageService;
    }
    show() {
        const ref = this.dialogService.open(_carslistdemo__WEBPACK_IMPORTED_MODULE_4__["CarsListDemo"], {
            header: 'Choose a Car',
            width: '70%',
            contentStyle: { "max-height": "350px", "overflow": "auto" }
        });
...
DynamicDialogDemo.ctorParameters = () => [
...
//# sourceMappingURL=components-dynamicdialog-dynamicdialogdemo-module-es2015.js.map