(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~components-calendar-calendardemo-module~components-focustrap-focustrapdemo-module~components~dcaec443"],{
...
var CALENDAR_VALUE_ACCESSOR = {
    ...
    useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () { return Calendar; }),
    multi: true
};
var Calendar = /** @class */ (function () {
    ...
    Calendar.prototype.onInputClick = function (event) {
        if (this.overlay && this.autoZIndex) {
            this.overlay.style.zIndex = String(this.baseZIndex + (++_dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].zindex));
        }
    ...
    Calendar.prototype.appendOverlay = function () {
        if (this.appendTo) {
            if (this.appendTo === 'body')
                ...
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].appendChild(this.overlay, this.appendTo);
        }
    };
    ...
    Calendar.prototype.alignOverlay = function () {
        if (this.touchUI) {
            ...
            if (this.appendTo)
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].absolutePosition(this.overlay, this.inputfieldViewChild.nativeElement);
            else
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].relativePosition(this.overlay, this.inputfieldViewChild.nativeElement);
        }
    };
    Calendar.prototype.enableModality = function (element) {
        ...
        if (!this.mask) {
            ...
            _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].addMultipleClasses(this.mask, maskStyleClass);
            this.maskClickListener = this.renderer.listen(this.mask, 'click', function (event) {
                _this.disableModality();
            });
            document.body.appendChild(this.mask);
            _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].addClass(document.body, 'ui-overflow-hidden');
        }
    };
    Calendar.prototype.disableModality = function () {
        if (this.mask) {
            ...
            for (var i = 0; i < bodyChildren.length; i++) {
                ...
                if (_dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].hasClass(bodyChild, 'ui-datepicker-mask-scrollblocker')) {
                    hasBlockerMasks = true;
                    break;
                }
            }
            if (!hasBlockerMasks) {
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].removeClass(document.body, 'ui-overflow-hidden');
            }
    ...
    Calendar.prototype.isNavIconClicked = function (event) {
        return (_dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].hasClass(event.target, 'ui-datepicker-prev') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].hasClass(event.target, 'ui-datepicker-prev-icon')
            || _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].hasClass(event.target, 'ui-datepicker-next') || _dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].hasClass(event.target, 'ui-datepicker-next-icon'));
    };
    Calendar.prototype.onWindowResize = function () {
        if (this.overlayVisible && !_dom_domhandler__WEBPACK_IMPORTED_MODULE_5__["DomHandler"].isAndroid()) {
            this.hideOverlay();
        }
    };
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('inputfield', { static: false }),
    ...
    Calendar = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
            ...
            animations: [
                Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["trigger"])('overlayAnimation', [
                    ...
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["transition"])('void => visible', [
                        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["style"])({ transform: 'translateY(5%)', opacity: 0 }),
                    ...
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["transition"])('void => visibleTouchUI', [
                        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["style"])({ opacity: 0, transform: 'translate3d(-50%, -40%, 0) scale(0.9)' }),
                        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["animate"])('{{showTransitionParams}}')
                    ]),
                    Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["transition"])('visibleTouchUI => void', [
                        Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["animate"])(('{{hideTransitionParams}}'), Object(_angular_animations__WEBPACK_IMPORTED_MODULE_2__["style"])({
                            opacity: 0,
...
var CalendarModule = /** @class */ (function () {
    ...
    CalendarModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _button_button__WEBPACK_IMPORTED_MODULE_4__["ButtonModule"], _common_shared__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]],
            exports: [Calendar, _button_button__WEBPACK_IMPORTED_MODULE_4__["ButtonModule"], _common_shared__WEBPACK_IMPORTED_MODULE_6__["SharedModule"]],
...
//# sourceMappingURL=default~components-calendar-calendardemo-module~components-focustrap-focustrapdemo-module~components~dcaec443-es5.js.map