...
let SelectButton = class SelectButton {
    ...
    set options(val) {
        let opts = this.optionLabel ? _utils_objectutils__WEBPACK_IMPORTED_MODULE_3__["ObjectUtils"].generateSelectItems(val, this.optionLabel) : val;
        this._options = opts;
    }
    writeValue(value) {
        this.value = value;
...
//# sourceMappingURL=components-selectbutton-selectbuttondemo-module-es2015.js.map