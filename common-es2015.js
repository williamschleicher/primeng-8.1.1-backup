    ...
    onFocus(e) {
        if (this.feedback) {
            ...
            this.zone.runOutsideAngular(() => {
                setTimeout(() => {
                    _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].addClass(this.panel, 'ui-password-panel-visible');
                    _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].removeClass(this.panel, 'ui-password-panel-hidden');
                }, 1);
                _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].absolutePosition(this.panel, this.el.nativeElement);
            });
        }
    }
    onBlur(e) {
