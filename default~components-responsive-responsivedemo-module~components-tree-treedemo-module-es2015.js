...
UITreeNode.ctorParameters = () => [
    { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => Tree),] }] }
];
...
UITreeNode = UITreeNode_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(() => Tree))),
...
let Tree = class Tree {
    ...
    onFilter(event) {
        ...
        if (filterValue === '') {
            ...
            const filterText = _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].removeAccents(filterValue).toLowerCase();
    ...
    isFilterMatched(node, { searchFields, filterText, isStrictMode }) {
        ...
        for (let field of searchFields) {
            let fieldValue = _utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].removeAccents(String(_utils_objectutils__WEBPACK_IMPORTED_MODULE_5__["ObjectUtils"].resolveFieldData(node, field))).toLowerCase();
...
//# sourceMappingURL=default~components-responsive-responsivedemo-module~components-tree-treedemo-module-es2015.js.map