...
var Tooltip = /** @class */ (function () {
    ...
    Tooltip.prototype.getHostOffset = function () {
        if (this.appendTo === 'body' || this.appendTo === 'target') {
            ...
            var targetLeft = offset.left + _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getWindowScrollLeft();
            var targetTop = offset.top + _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getWindowScrollTop();
    ...
    Tooltip.prototype.alignRight = function () {
        ...
        var left = hostOffset.left + _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.el.nativeElement);
        var top = hostOffset.top + (_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.el.nativeElement) - _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container)) / 2;
    ...
    Tooltip.prototype.alignLeft = function () {
        this.preAlign('left');
        var hostOffset = this.getHostOffset();
        var left = hostOffset.left - _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container);
        var top = hostOffset.top + (_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.el.nativeElement) - _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container)) / 2;
        this.container.style.left = left + 'px';
        this.container.style.top = top + 'px';
    };
    Tooltip.prototype.alignTop = function () {
        this.preAlign('top');
        var hostOffset = this.getHostOffset();
        var left = hostOffset.left + (_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.el.nativeElement) - _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container)) / 2;
        var top = hostOffset.top - _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container);
        this.container.style.left = left + 'px';
        this.container.style.top = top + 'px';
    };
    Tooltip.prototype.alignBottom = function () {
        ...
        var hostOffset = this.getHostOffset();
        var left = hostOffset.left + (_dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.el.nativeElement) - _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container)) / 2;
        var top = hostOffset.top + _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.el.nativeElement);
        this.container.style.left = left + 'px';
        this.container.style.top = top + 'px';
    };
    ...
    Tooltip.prototype.isOutOfBounds = function () {
        ...
        var width = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterWidth(this.container);
        var height = _dom_domhandler__WEBPACK_IMPORTED_MODULE_3__["DomHandler"].getOuterHeight(this.container);
...
//# sourceMappingURL=default~components-accordion-accordiondemo-module~components-autocomplete-autocompletedemo-module~co~c48df3a3-es5.js.map