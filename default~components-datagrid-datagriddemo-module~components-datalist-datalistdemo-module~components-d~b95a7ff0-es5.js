...
var Dropdown = /** @class */ (function () {
    ...
    Object.defineProperty(Dropdown.prototype, "options", {
        ...
        set: function (val) {
            var opts = this.optionLabel ? _utils_objectutils__WEBPACK_IMPORTED_MODULE_7__["ObjectUtils"].generateSelectItems(val, this.optionLabel) : val;
            this._options = opts;
    ...
    Dropdown.prototype.ngAfterViewChecked = function () {
        ...
        if (this.selectedOptionUpdated && this.itemsWrapper) {
            ...
            var selectedItem = _dom_domhandler__WEBPACK_IMPORTED_MODULE_6__["DomHandler"].findSingle(this.overlay, 'li.ui-state-highlight');
            if (selectedItem) {
        ...
        switch (event.toState) {
            case 'visible':
                ...
                if (this.options && this.options.length) {
                    if (!this.virtualScroll) {
                        var selectedListItem = _dom_domhandler__WEBPACK_IMPORTED_MODULE_6__["DomHandler"].findSingle(this.itemsWrapper, '.ui-dropdown-item.ui-state-highlight');
                        if (selectedListItem) {
        ...
        if (this.options && this.options.length) {
            if (this.group) {
                ...
                for (var _i = 0, _a = this.options; _i < _a.length; _i++) {
                    var optgroup = _a[_i];
                    var filteredSubOptions = _utils_filterutils__WEBPACK_IMPORTED_MODULE_9__["FilterUtils"].filter(optgroup.items, searchFields, this.filterValue, this.filterMatchMode);
...
//# sourceMappingURL=default~components-datagrid-datagriddemo-module~components-datalist-datalistdemo-module~components-d~b95a7ff0-es5.js.map