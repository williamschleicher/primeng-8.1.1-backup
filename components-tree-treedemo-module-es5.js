...
var TreeDemoRoutingModule = /** @class */ (function () {
...
var TreeDemo = /** @class */ (function () {
    function TreeDemo(nodeService, messageService) {
    ...
    TreeDemo.prototype.ngOnInit = function () {
        ...
        this.nodeService.getFiles().then(function (files) { return _this.filesTree11 = files; });
        this.nodeService.getFiles().then(function (files) { return _this.filesTree12 = files; });
        ...
        this.items = [
            { label: 'View', icon: 'fa fa-search', command: function (event) { return _this.viewFile(_this.selectedFile2); } },
            { label: 'Unselect', icon: 'fa fa-close', command: function (event) { return _this.unselectFile(); } }
        ];
    };
    ...
    TreeDemo.ctorParameters = function () { return [
